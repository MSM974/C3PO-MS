...
const MenuCard = ({
  ...
  return (
    <div className="border rounded p-3 bg-white text-navy">
      ...
      <p className="pt-4">
        <strong className="menu-title">Entrée :</strong><br />{entree}</p>
      <p>
        <strong className="menu-title">Plat :</strong><br />{plat}</p>
      <p>
        <strong className="menu-title">Dessert :</strong><br />{dessert}</p>
